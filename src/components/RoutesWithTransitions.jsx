...
const LocaliteHlmGrandYoff = lazy(() =>
  import("../pages/localites/HlmGrandYoff")
);
...
export default function RoutesWithTransitions() {
  ...
  return (
    <Routes location={displayLocation} key={displayLocation.pathname}>
      ...
      <Route
        path="/cabinet-dentaire-liberte-6"
        element={<LocaliteLiberte6 />}
      />
      <Route
      ...
      <Route
        path="/cabinet-dentaire-sacre-coeur"
        element={<LocaliteSacreCoeur />}
      />
      <Route path="/cabinet-dentaire-yoff" element={<LocaliteYoff />} />
      <Route
        path="/cabinet-dentaire-hlm-grand-yoff"
        element={<LocaliteHlmGrandYoff />}
      />
      <Route
        path="/cabinet-dentaire-scat-urbam"
        element={<LocaliteScatUrbam />}
      />
      <Route path="/cabinet-dentaire-ngor" element={<LocaliteNgor />} />
      <Route path="/cabinet-dentaire-ouakam" element={<LocaliteOuakam />} />
      <Route
        path="/cabinet-dentaire-patte-d-oie"
        element={<LocalitePatteDOie />}
      />
