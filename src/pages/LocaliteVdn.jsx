...
export default function LocaliteVdn() {
  const url = "https://www.cliniquedentairedabia.com/cabinet-dentaire-vdn";
  const jsonLd = [
    {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – proche VDN",
      url,
      image: "/og-image.webp",
      telephone: "+221****9393",
      address: {
      ...
      areaServed: ["VDN", "Liberté 6", "Sicap Foire", "Mermoz", "Yoff"],
  ...
  return (
    <section className="py-20 px-4 max-w-5xl mx-auto mt-20">
      ...
      <Breadcrumbs
        items={[
          { label: "Accueil", href: "/" },
          { label: "Clinique dentaire VDN" },
        ]}
      />

      <h1 className="text-3xl md:text-4xl font-bold text-[#ad9d64]">
        Clinique dentaire proche de la VDN (Dakar)
      </h1>
      <ReactMarkdown
        components={{
          p: ({ node, ...props }) => (
      ...
      >
        {`La Clinique Dentaire DABIA est située à **Sicap Foire**, à deux pas de la **VDN** (Voie de Dégagement Nord) et de **Liberté 6**. Elle accueille les patient·es de la VDN, de **Mermoz**, **Yoff**, **Sicap Foire** et alentours pour les soins du quotidien (prévention, détartrage, caries), l’**urgence dentaire**, ainsi que l’**esthétique**, l’**orthodontie** et l’**implantologie**.`}
      </ReactMarkdown>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        <div className="p-5 border rounded-xl bg-white">
          ...
          <ul className="space-y-2 text-gray-700 text-sm">
            <li>
              Adresse : Sicap Foire, 2 voies Liberté 6 (à 150m du Uno), Dakar — accès facile depuis la VDN
            </li>
            <li>
              Téléphone :{" "}
