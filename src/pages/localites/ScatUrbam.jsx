...
export default function LocaliteScatUrbam() {
  const url =
    "https://www.cliniquedentairedabia.com/cabinet-dentaire-scat-urbam";
  const jsonLd = [
    {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      >
        Notre cabinet de Sicap Foire accueille les patients de Scat Urbam avec
      ...
      <Callout title="Informations utiles">
        <ul className="list-disc pl-5">
          ...
          <li>
            Soins esthétiques: des photos avant/après peuvent être proposées.
          </li>
        </ul>
      </Callout>
    </section>
