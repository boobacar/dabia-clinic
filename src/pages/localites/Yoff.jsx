...
export default function LocaliteYoff() {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-[#ad9d64]">Dentiste proche de Yoff</h1>
      <p className="mt-3 text-gray-700">Accès rapide depuis Yoff. Contactez‑nous pour une prise en charge rapide.</p>
