...
export default function LocaliteYoff() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – Yoff (proche)",
      url,
      image: "/og-image.webp",
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      />
      <Breadcrumbs
        items={[{ label: "Accueil", href: "/" }, { label: "Dentiste Yoff" }]}
      />
      <motion.h1
      ...
      >
        Accès rapide depuis Yoff. Contactez‑nous pour une prise en charge
        rapide.
      </motion.p>
