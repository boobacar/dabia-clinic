...
export default function LocaliteMermoz() {
  ...
  const jsonLd = [
    { "@context": "https://schema.org", "@type": "LocalBusiness", name: "Clinique Dentaire DABIA – Mermoz (proche)", url, image: "/og-image.jpg", telephone: "+221777039393", address: { "@type": "PostalAddress", streetAddress: "Sicap Foire, 2 voies Liberté 6 (à 150m du Uno)", addressLocality: "Dakar", addressCountry: "SN" }, areaServed: ["Mermoz", "Sicap Foire", "Point E", "Ouakam"], openingHours: ["Mo-Fr 09:00-18:00", "Sa 09:00-14:00"], priceRange: "CFA" },
  ];
