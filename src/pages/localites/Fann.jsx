...
export default function LocaliteFann() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – Fann (proche)",
      url,
      image: "/og-image.webp",
      ...
      areaServed: ["Fann", "Point E", "Mermoz"],
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      />
      <Breadcrumbs
        items={[{ label: "Accueil", href: "/" }, { label: "Dentiste Fann" }]}
      />
      <motion.h1
      ...
      >
        Accès simple depuis Fann, prise en charge complète.
      </motion.p>
