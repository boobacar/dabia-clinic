...
export default function LocaliteAlmadies() {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      >
        Cabinet moderne à quelques minutes des Almadies : urgences, prévention,
        esthétique, orthodontie, implantologie.
      </motion.p>
      ...
      <Callout title="Astuces pour venir">
        <ul className="list-disc pl-5">
          <li>
            Stationnement à proximité — prévoyez quelques minutes d’avance.
          </li>
