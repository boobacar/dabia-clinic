...
export default function LocaliteOuakam() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – Ouakam (proche)",
      url,
      image: "/og-image.webp",
      ...
      areaServed: ["Ouakam", "Almadies", "Ngor", "Mamelles"],
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      />
      <Breadcrumbs
        items={[{ label: "Accueil", href: "/" }, { label: "Dentiste Ouakam" }]}
      />
      <motion.h1
