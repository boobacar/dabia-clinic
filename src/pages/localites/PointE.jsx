...
export default function LocalitePointE() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – Point E (proche)",
      url,
      image: "/og-image.webp",
      ...
      areaServed: ["Point E", "Mermoz", "Sicap Foire"],
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      />
      <Breadcrumbs
        items={[{ label: "Accueil", href: "/" }, { label: "Dentiste Point E" }]}
      />
      <motion.h1
      ...
      >
        Notre cabinet de Sicap Foire accueille les patients du Point E avec une
