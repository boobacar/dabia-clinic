...
export default function LocaliteHlmGrandYoff() {
  const url =
    "https://www.cliniquedentairedabia.com/cabinet-dentaire-hlm-grand-yoff";
  const jsonLd = [
    {
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      >
        Dentiste proche de HLM Grand Yoff
      </motion.h1>
      <motion.p
      ...
      >
        Cabinet moderne à quelques minutes de HLM Grand Yoff : urgences,
        prévention, esthétique, orthodontie, implantologie.
      </motion.p>
      ...
      <Callout title="Astuces pour venir">
        <ul className="list-disc pl-5">
          ...
          <li>
            Urgence: contactez‑nous pour organiser un passage prioritaire.
          </li>
        </ul>
      </Callout>
    </section>
