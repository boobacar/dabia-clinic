...
export default function LocaliteNgor() {
  ...
  const jsonLd = [
    {
      ...
      "@type": "LocalBusiness",
      name: "Clinique Dentaire DABIA – Ngor (proche)",
      url,
      image: "/og-image.webp",
      ...
      areaServed: ["Ngor", "Almadies", "Yoff", "Ouakam"],
  ...
  return (
    <section className="py-20 px-4 max-w-6xl mx-auto mt-20">
      ...
      />
      <Breadcrumbs
        items={[{ label: "Accueil", href: "/" }, { label: "Dentiste Ngor" }]}
      />
      <motion.h1
      ...
      >
        Accès rapide depuis Ngor. Prise en charge complète.
      </motion.p>
