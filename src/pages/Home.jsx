...
export default function Home() {
  return <main className="home-page">
    ...
    <nav className="seo-pathways" aria-label="Accès directs"><div className="studio-container"><Link to="/dentiste-dakar">Dentiste Dakar</Link><Link to="/tourisme-dentaire-dakar">Tourisme dentaire Dakar</Link><Link to="/pays">Patients internationaux</Link><Link to="/cabinet-dentaire-dakar">Cabinet dentaire Dakar</Link><Link to="/clinique-dentaire-dakar">Clinique dentaire Dakar</Link><Link to="/en/dental-clinic-dakar">Dental clinic Dakar (EN)</Link><Link to="/cabinet-dentaire-liberte-6">Liberté 6</Link><Link to="/cabinet-dentaire-vdn">VDN</Link><Link to="/urgence-dentaire-dakar">Urgence dentaire</Link><Link to="/all-competences">Nos compétences</Link><Link to="/infos/assurances">Assurances</Link><Link to="/infos/technologie">Technologie</Link></div></nav>
  </main>;
}
